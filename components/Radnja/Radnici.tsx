...
const Radnici: React.FC<ZakazivanjeProps> = ({ setZakazi,radnja }) => {
  ...
  return (
    <div className="bg-white px-4 pt-12 md:p-12 md:max-h-max rounded-t-3xl md:rounded-xl flex flex-col gap-4 mx-0 lg:mx-64 mt-6 absolute left-0 right-0 bottom-0 h-[90%] md:h-auto">
