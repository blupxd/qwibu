  ...
  return (
    <div className="flex flex-col mb-0 md:mb-12 px-4 md:px-0">
      ...
      <div className="relative">
        <div
          ref={scrollerRef}
          className="-mx-4 lg:mx-0 pl-4 scroll-px-4 scroller auto-cols-[72%] md:auto-cols-[58%] xl:auto-cols-[52%] 2xl:auto-cols-[22%] snaps-inline gap-x-12"
        >
          {usluge.map((usluga: Usluga, key: number) => (
